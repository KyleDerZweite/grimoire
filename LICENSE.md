...
Required Notice: Copyright (C) 2026 KyleDerZweite (https://github.com/KyleDerZweite)
...
## Creative Assets - All Rights Reserved

The following additional terms apply to all Creative Assets
contained in this repository:

'Creative Assets' means all artwork, illustrations, images,
graphics, logos, icons, character designs, visual designs, audio
files, and any other non-code media files - including but not limited
to files in public/ directories, and any .png, .jpg, .jpeg, .gif,
.svg, .webp, .avif, .ico, .mp3, .mp4, .ogg, .wav, .webm files
anywhere in the repository.

All Creative Assets are copyright their respective owners and are
All Rights Reserved. No license, express or implied, is granted
under this document or any other terms for any Creative Asset.

You may NOT copy, redistribute, modify, create derivative works
from, publicly display, or use any Creative Asset for any purpose
without prior written permission from the copyright holder.

The PolyForm Noncommercial License above applies ONLY to the
